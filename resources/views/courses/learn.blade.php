        ...
        <div class="courses-enroll-wrapper">
            ...
            <div class="courses-video-player">
                ...
                <div class="vidcontainer">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/{{ $content->body['id'] }}?start=8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
